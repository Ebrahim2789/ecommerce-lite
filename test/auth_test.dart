...
void main() {
  group("Mock Authentication", () {
    ...
    test('Cannot log out if not initailized', () {
    ...
    test(
      'Should be initialzed less than two second ',
      () async {
        await provider.initialize();
        expect(provider.isInitialized, true);
      },
    ...
    test('Create user should delegate to login funcation', () async {
      final badEmailUser = provider.createUsre(
        email: 'foo@bar.com',
      ...
      final badPasswordUser = provider.createUsre(
      ...
      final user = await provider.createUsre(
        email: 'foo',
        password: "bar",
      );
    ...
    test('Should be log out and log in agian', () async {
