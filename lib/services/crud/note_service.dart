import 'dart:async';
import 'package:dalell/services/crud/curd_exeptions.dart';
...
class DatabaseNote {
  ...
  @override
  String toString() =>
      'Note, ID=$id,userid=$userId, isSyncowithcloud=$isSyncedWithCloud,text=$text';
...
const issyncColumn = 'is_syncrd_with_cloud';
...
"text"	TEXT NOT NULL,
"is_syncrd_with_cloud"	INTEGER NOT NULL DEFAULT 0,
PRIMARY KEY("id" AUTOINCREMENT),
